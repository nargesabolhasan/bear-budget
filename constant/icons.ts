...
import WorkspacesFilledIcon from "@mui/icons-material/WorkspacesFilled";
...
export const iconListGenerator = (): IconOptionMap => {
  ...
  icons.forEach((icon, index) => {
    list.set(index.toString(), { id: index.toString(), icon: icon });
  });
  return list;
};

export const iconList: IconOptionMap = iconListGenerator();
