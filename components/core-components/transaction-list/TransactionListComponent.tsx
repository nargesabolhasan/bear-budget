...
import AllTransactions from "@/components/core-components/transaction-list/all-view";
import FilterView from "@/components/core-components/transaction-list/filters-view";
import { TransactionEnum, TransactionType, ViewEnums } from "@/types/global";
import SuperGroupList from "@/components/core-components/transaction-list/super-group-view";
...
const TransactionListComponent = ({
  ...
  return (
    <div className={"mx-auto pb-25 md:w-1/2 md:px-3 print:p-0"}>
