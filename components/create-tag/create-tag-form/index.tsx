...
import {FormTagEnum, TagFormData,} from "@/components/create-tag/create-tag-form/type";
...
const CreateTagForm = ({submitHandler, ...props}: Partial<TagFormData> & { submitHandler: (data: TagFormData) => void }) => {
